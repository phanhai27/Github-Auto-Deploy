...
h1. What is it? (Supported python3)
...
* start the server by typing "python3 GitAutoDeploy.py" 
* to run it as a daemon add ==--daemon-mode==
* On the Github page go to a repository, then "Settings", "Webhooks", "Add webhook"
"Payload URL" and add the url of your machine + port (e.g. http://example.com:8001).
